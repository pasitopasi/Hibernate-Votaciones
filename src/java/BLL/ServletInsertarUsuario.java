...
public class ServletInsertarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Votante user = new Votante(dni, nombre, apellido, contrasena.getBytes());
            user.setVoto("");
            String d =  new String(contrasena.getBytes(),  Charset.forName("UTF-8"));
            out.print("<br>");
            if (new Operaciones().IntroducirUsuario(sessionbuilder, user)) {
